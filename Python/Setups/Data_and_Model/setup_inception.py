## Modified from https://github.com/IBM/ZOO-Attack
...
class InceptionModelPrediction:
  def __init__(self, sess, use_log = True):
    self.sess = sess
...
class InceptionModel:
  ...
  def predict(self, img):
    ...
    # scaled = (0.5+img)*255
    print('image shape ,', img.shape, type(img.shape))
...
class ImageNet:
  def __init__(self, path='images'):
    ...
    #pool = Pool(8)
    path = main_dir+'/Data/ImageNet/images'
