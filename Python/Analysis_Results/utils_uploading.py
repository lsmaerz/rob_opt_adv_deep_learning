...
def uploading_name(attack, args):
    """
    This returns the string of the directory of where the attack results are saved
    """
    if attack=='boby':
...
def import_results(attack, args, both=False):
    """
    This function uploads the results relative to input attack and with the required args
    """
    if both:
        args.Adversary=True
